...
train_features = np.reshape(train_features, (4558, 5 * 5 * 1280))
validation_features = np.reshape(validation_features, (1302, 5 * 5 * 1280))
test_features = np.reshape(test_features, (652, 5 * 5 * 1280))
